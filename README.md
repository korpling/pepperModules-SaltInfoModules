...
The SaltInfoExporter comes with a default flat design style. For our demonstration we used the pcc2 corpus, which is a subset of the pcc corpus (see: https://www.ling.uni-potsdam.de/acl-lab/Forsch/pcc/pcc.html). The corpus site generated by the SaltInfoExporter of this corpus can be found [here](./gh-site/samples/b4.tatian/index.html).
